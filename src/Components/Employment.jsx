...
import './ResponsiveCss/Education.css'
    ...
    return (
        <div className='w-[70vw] mx-auto main-container'>
            <div className='text-center'>
                <p className='font-bold text-[30px] text-blue-700 main-text'>Fill the Employment Details here</p>
            </div>

            <div className='w-[70vw] h-[1px] mx-auto bg-black mt-5'></div>

            <div className='w-[55vw] mx-auto web-details Web-Details'>
                        ...
                        <div className='name flex flex-col gap-2'>
                            ...
                            <div className='flex gap-2 two-names'>
                                <div className="firstname">
                                    <input type="text"
                                        className='firstbox-name border-[1px] rounded-md h-[40px] w-[220px] border-gray-400 bg-transparent'
                                        name='dfirstname'
